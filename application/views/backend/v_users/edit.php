...
<div class="content">
  ...
  <div class="grid grid-cols-16 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-6">
      <!-- BEGIN: Form Layout -->
      <form class="" action="<?php echo site_url('Users/update/' . $edit['id_users'])
        ?>" method="post">
        <div class="intro-y box p-5">
          <div>
            <label for="crud-form-1" class="form-label">Kode User</label>
            <input id="crud-form-1" type="text" name="id_users" class="form-control w-full" placeholder="<?php echo
              $edit['id_users'] ?>" value="<?php echo $edit['id_users'] ?>" disabled>
          </div>
          <div class="mt-3">
          ...
          <div class="mt-3">
            ...
            <input id="crud-form-1" type="text" name="pswd_users" class="form-control w-full" placeholder="<?php echo
              $edit['pswd_users'] ?>" value="<?php echo $edit['pswd_users'] ?>" autocomplete="off">
          </div>
          <div class="mt-3">
                  <label for="crud-form-1" class="form-label">Divisi</label>
                  <input id="crud-form-1" type="text" name="divisi" class="form-control w-full" placeholder="IPDS"
          ...
          <div class="text-right mt-5">
            <a href="<?php echo site_url('Users') ?>"><button type="button"
