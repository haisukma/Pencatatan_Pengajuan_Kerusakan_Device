...
<div class="content">
    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
        <a href="<?php echo site_url('Users/create') ?>"> <button
                ...
                <div class="dropdown w-1/2 sm:w-auto">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            ...
                            <li>
                                <a id="tabulator-export-xlsx" href="<?php echo site_url('Users/excelAdmin') ?>"
                                    class="dropdown-item">
                                ...
                                <div class="flex flex-col lg:flex-row items-center p-5">
                                    ...
                                    <div class="flex mt-4 lg:mt-0">
                                        <a class="btn btn-primary w-24 mr-1 mb-2"
                                            href="<?php echo site_url('Users/edit/' . $row['id_users']) ?>"> <i
                                                data-lucide="edit" class="w-4 h-4 mr-1"></i>Edit</a>
                                        <a class="btn btn-danger w-24 mr-1 mb-2"
                                            href="<?php echo site_url('Users/delete/' . $row['id_users']) ?>"
                ...
                <div class="dropdown w-1/2 sm:w-auto">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            ...
                            <li>
                                <a id="tabulator-export-xlsx" href="<?php echo site_url('Users/excelUser') ?>"
                                    class="dropdown-item">
                                    <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Export XLSX
                                </a>
                            </li>
