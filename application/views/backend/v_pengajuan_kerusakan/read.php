...
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-5">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?php echo site_url('Perangkat/create') ?>">
                ...
                <table id="wajib-pajak-table" class="table table-report -mt-2">
                    ...
                    <tbody>
                        ...
                        foreach ($read->result_array() as $row) {
                            if ($row['id_pengajuan'] == $this->session->userdata('id_pengajuan')) {
                                ?>
                                <tr class="intro-x">
                                    <td class="w-40">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3"
                                                href="<?php echo site_url('Perangkat/edit/' . $row['id_pengajuan']) ?>"> <i
                                                    data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit </a>
                                            <a class="flex items-center text-danger"
                                                href="<?php echo site_url('Perangkat/delete/' . $row['id_pengajuan']) ?>"
                                                onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['id_pengajuan'], ' ', $row['nama']; ?>')">
