...
<head>
    <meta charset="utf-8">
    <link href="<?= base_url(); ?>assets/dist/images/logo bps.png" rel="shortcut icon">
    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="" class="flex mr-auto">
                <img alt="" class="w-6" src="<?= base_url(); ?>assets/dist/images/logo bps.png">
                <span class="text-white text-lg ml-3"> BPS </span>
            </a>
        ...
        <ul class="border-t border-white/[0.08] py-5 hidden">
            ...
            <li>
                <a href="<?php echo site_url('Pengajuan _Kerusakan') ?>" class="menu">
    ...
    <div class="border-b border-white/[0.08] -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10">
        <div class="top-bar-boxed flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="BPS Jepara" class="w-6" src="<?= base_url(); ?>assets/dist/images/logo bps.png">
                <span class="text-white text-lg ml-3"> BPS Jepara </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
